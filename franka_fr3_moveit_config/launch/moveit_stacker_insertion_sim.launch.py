...
def generate_launch_description():
    ...
    start_stacker_script_parameter_name = 'start_stacker_script'
    ...
    start_stacker_script = LaunchConfiguration(start_stacker_script_parameter_name)

    # Command-line arguments
    robot_arg = DeclareLaunchArgument(
        robot_ip_parameter_name,
        default_value='172.16.0.2',  # Default robot IP
    ...
    use_fake_hardware_arg = DeclareLaunchArgument(
        ...
        default_value='true',  # Default to simulation mode
    ...
    start_stacker_script_arg = DeclareLaunchArgument(
        start_stacker_script_parameter_name,
        default_value='true',
        description='Start the moveit_stacker_insertion script automatically')
    ...
    # MoveIt Stacker Insertion Script (for simulation)
    moveit_stacker_insertion_node = Node(
        package='franka_example_controllers',
        executable='moveit_stacker_insertion',
        name='moveit_stacker_insertion',
        namespace=namespace,
        output='screen',
        parameters=[
            robot_description,
        ...
        condition=IfCondition(use_fake_hardware),  # Only run with fake hardware (simulation)
    )
